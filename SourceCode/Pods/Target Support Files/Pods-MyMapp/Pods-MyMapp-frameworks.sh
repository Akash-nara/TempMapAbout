...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ELWaterFallLayout/ELWaterFallLayout.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FSInteractiveMap/FSInteractiveMap.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/IQKeyboardManagerSwift/IQKeyboardManagerSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/InfiniteScrollCollectionView/InfiniteScrollCollectionView.framework"
