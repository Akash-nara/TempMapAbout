...
class OtherProfileHomeVC: UIViewController {
    enum EnumMap {
        case map, tripData
    }
...
extension OtherProfileHomeVC: UICollectionViewDataSource,UICollectionViewDelegate{
...
extension OtherProfileHomeVC: CHTCollectionViewDelegateWaterfallLayout {
...
//                    return CGSize(width: collectionView.frame.size.width, height: 80)
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        cell.configureUserObject(tripObj: self.objTripDataModel)
        switch self.selectedTab {
...
extension OtherProfileHomeVC: CLLocationManagerDelegate {
...
extension OtherProfileHomeVC:UITextFieldDelegate{
...
extension OtherProfileHomeVC: UIScrollViewDelegate {
